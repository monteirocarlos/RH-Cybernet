                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="ferias.php">Controle de Férias</a><a class="nav-link" href="vagas.php">Vagas</a><a class="nav-link" href="banco_talentos.php">Banco de talentos</a>
                                </nav>
                            </div>
